    ...
    , mRelationsList( nullptr )
{
  ...
  mAddAttributeButton->setIcon( eqiApplication::getThemeIcon( "/mActionNewAttribute.png" ) );
  mDeleteAttributeButton->setIcon( eqiApplication::getThemeIcon( "/mActionDeleteAttribute.png" ) );
  mToggleEditingButton->setIcon( eqiApplication::getThemeIcon( "/mActionToggleEditing.svg" ) );
  mCalculateFieldButton->setIcon( eqiApplication::getThemeIcon( "/mActionCalculateField.png" ) );
...
void QgsFieldsProperties::setRow( int row, int idx, const QgsField& field )
{
  ...
  switch ( mLayer->fields().fieldOrigin( idx ) )
  {
    case QgsFields::OriginExpression:
      dataItem->setIcon( eqiApplication::getThemeIcon( "/mIconExpression.svg" ) );
      break;

    case QgsFields::OriginJoin:
      dataItem->setIcon( eqiApplication::getThemeIcon( "/propertyicons/join.png" ) );
      break;
  ...
  if ( mLayer->fields().fieldOrigin( idx ) == QgsFields::OriginExpression )
  {
    ...
    editExpressionButton->setIcon( eqiApplication::getThemeIcon( "/mIconExpression.svg" ) );
...
QTreeWidgetItem* DesignerTree::addItem( QTreeWidgetItem* parent, QgsFieldsProperties::DesignerTreeItemData data )
{
  ...
  if ( data.type() == QgsFieldsProperties::DesignerTreeItemData::Container )
  {
    ...
    {
      case DesignerTreeItemData::Field:
        newItem->setIcon( 0, eqiApplication::getThemeIcon( "/mFieldIcon.svg" ) );
        break;

      case DesignerTreeItemData::Relation:
        newItem->setIcon( 0, eqiApplication::getThemeIcon( "/mRelationIcon.svg" ) );
        break;

      case DesignerTreeItemData::Container:
        newItem->setIcon( 0, eqiApplication::getThemeIcon( "/mContainerIcon.svg" ) );
        break;
    }
#endif
  }
