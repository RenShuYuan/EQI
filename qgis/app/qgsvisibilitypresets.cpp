    ...
    : mMenu( new QMenu )
{
  ...
  mMenu->addAction( MainWindow::instance()->actionShowAllLayers() );
  mMenu->addAction( MainWindow::instance()->actionHideAllLayers() );
  mMenu->addAction( MainWindow::instance()->actionShowSelectedLayers() );
  mMenu->addAction( MainWindow::instance()->actionHideSelectedLayers() );
  mMenu->addSeparator();
...
{
  QgsLayerTreeModel* model = MainWindow::instance()->layerTreeView()->layerTreeModel();
...
QStringList QgsVisibilityPresets::orderedPresetVisibleLayers( const QString& name ) const
{
  ...
  QgsLayerTreeMapCanvasBridge* bridge = MainWindow::instance()->layerTreeCanvasBridge();
