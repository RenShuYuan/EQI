...
#include "app/qgsjoindialog.h"
#include "qgsapplication.h"
#include "app/qgsattributeactiondialog.h"
#include "plugins/qgsapplydialog.h"
#include "qgscontexthelp.h"
#include "qgscoordinatetransform.h"
#include "app/qgsdiagramproperties.h"
#include "qgsdiagramrendererv2.h"
#include "qgsfieldcalculator.h"
#include "app/qgsfieldsproperties.h"
#include "app/qgslabeldialog.h"
#include "app/qgslabelingwidget.h"
#include "qgslabel.h"
#include "qgsgenericprojectionselector.h"
#include "qgslogger.h"
#include "qgsmaplayerregistry.h"
#include "qgsmaplayerstyleguiutils.h"
#include "app/qgspluginmetadata.h"
#include "app/qgspluginregistry.h"
#include "qgsproject.h"
#include "app/qgssavestyletodbdialog.h"
#include "app/qgsloadstylefromdbdialog.h"
    ...
    , mFieldsPropertiesDialog( nullptr )
{
  ...
  if ( mLayer->hasGeometryType() )
  {
    ...
    layout->setMargin( 0 );
    labelingDialog = new QgsLabelingWidget( mLayer, MainWindow::instance()->mapCanvas(), labelingFrame );
  ...
  mActionDialog
 = new QgsAttributeActionDialog( *mLayer->actions(), actionOptionsFrame );
  mActionDialog
->layout()->setMargin( 0 );
  ...
  connect( this, SIGNAL( toggleEditing( QgsMapLayer* ) ), MainWindow::instance(), SLOT( toggleEditing( QgsMapLayer* ) ) );
  ...
  diagramPropertiesDialog = new QgsDiagramProperties( mLayer, mDiagramFrame, MainWindow::instance()->mapCanvas() );
...
void QgsVectorLayerProperties::on_mButtonAddJoin_clicked()
{
  ...
  if ( d.exec() == QDialog::Accepted )
  {
    ...
    pbnQueryBuilder->setEnabled( mLayer && mLayer->dataProvider() && mLayer->dataProvider()->supportsSubsetString() &&
                                 !mLayer->isEditable() );
    mFieldsPropertiesDialog->init();
  }
}
...
void QgsVectorLayerProperties::updateSymbologyPage()
{
  ...
  if ( mLayer->rendererV2() )
  {
    ...
    mRendererDialog->setMapCanvas( MainWindow::instance()->mapCanvas() );
