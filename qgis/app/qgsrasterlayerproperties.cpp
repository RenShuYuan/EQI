    ...
    , mHistogramWidget( nullptr )
{
  ...
  QIcon myPyramidPixmap( eqiApplication::getThemeIcon( "mIconPyramid.png" ) );
  QIcon myNoPyramidPixmap( eqiApplication::getThemeIcon( "mIconNoPyramid.png" ) );

  pbnAddValuesManually->setIcon( eqiApplication::getThemeIcon( "symbologyAdd.svg" ) );
  pbnAddValuesFromDisplay->setIcon( eqiApplication::getThemeIcon( "mActionContextHelp.png" ) );
  pbnRemoveSelectedRow->setIcon( eqiApplication::getThemeIcon( "symbologyRemove.svg" ) );
  pbnDefaultValues->setIcon( eqiApplication::getThemeIcon( "mActionOpenTable.svg" ) );
  pbnImportTransparentPixelValues->setIcon( eqiApplication::getThemeIcon( "mActionFileOpen.svg" ) );
  pbnExportTransparentPixelValues->setIcon( eqiApplication::getThemeIcon( "mActionFileSave.svg" ) );
...
// Alpha band is set in sync()
  ...
  mResetColorRenderingBtn->setIcon( eqiApplication::getThemeIcon( "mActionUndo.png" ) );
